...
public class load_Data extends AsyncTask<Void, Void, Void> {
    ...
    private ArrayList<product> contactList2 = new ArrayList<>();
    private ArrayList<product> contactList3 = new ArrayList<>();
                ...
                if (productsting != null) {
                    try {
                        ...
                        for (int i = 0; i < A.length(); i++) {
                            ...
                            contactList_details.add(i, list_details);
                        ...
                        mContex.runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                mContex.fill_Recy2(contactList2);
                                mContex.fill_Recy3(contactList3);
