...
public class Fragment_mostcheap extends Fragment {
    ...
    public static Fragment getInstance(ArrayList<product> list) {
        Fragment_mostcheap mostcheap=new Fragment_mostcheap();
        mostcheap.products=list;
        return mostcheap;
    }

    @Nullable
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.fragment_mostcheap,container,false);
//        ListView lv=view.findViewById(R.id.listview2);
//        productListAdabtor adabtor=new productListAdabtor(getActivity(),R.layout.list_item,products);
//        lv.setAdapter(adabtor);

         recyclerView=view.findViewById(R.id.recycl_list2);
    // load_Data load_data= (load_Data) new load_Data(this,recyclerView).execute();
